package com.anthem.rxsmart.config;
...
@Configuration
@EnableMongoRepositories(basePackages="com.anthem.rxsmart.repository")
public class MongoConfig extends AbstractMongoConfiguration {
	
	
	Logger logger = LoggerFactory.getLogger(MongoConfig.class);
	@Value("${com.anthem.rxsmart.mongodb.sslEnabled}")
	private boolean sslEnabled;

	@Value("${com.anthem.rxsmart.mongodb.datasource.url}")
	private String mongoClientUrl;

	@Value("${com.anthem.rxsmart.mongodb.database}")
	private String mongoDB;

	@Value("${com.anthem.rxsmart.mongodb.username}")
	private String username;

	@Value("${com.anthem.rxsmart.mongodb.password}")
	private String password;

	@Value("${com.anthem.rxsmart.mongodb.hostname}")
	private String hostname;

	@Value("${com.anthem.rxsmart.mongodb.port}")
	private int port;
